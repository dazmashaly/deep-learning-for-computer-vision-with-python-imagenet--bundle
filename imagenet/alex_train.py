...
opt = mx.optimizer.SGD(learning_rate=5e-3,momentum=0.9,wd=0.0005,rescale_grad=1.0 /batchSize)
...
aux_params=auxParams,num_epoch=90,begin_epoch=72)


batchEndCBs = [mx.callback.Speedometer(batchSize,500),mx.callback.ProgressBar(2,50)]
